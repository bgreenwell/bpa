...
## Installation
Package `bpa` is not currently available from CRAN, but the development version is hosted on GitHub at https://github.com/bgreenwell/bpa and can be downloaded using [`devtools`](https://github.com/hadley/devtools):
```r
