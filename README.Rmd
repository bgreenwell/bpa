...
## [6] "1915-01-01"
```
We can easily xtract the unique patterns:
```{r}
...
## [1] "9999-99-99"
```
However, suppose the dates are entered in multiple formats (perhaps the data arose from the merger of two data bases):
```{r}
dates[3] <- "01/01/1912"
dates[5] <- "01/01/1914"
print(dates)
